...
export default function UpdateCoupon() {
  ...
  const [startDate, setStartDate] = useState(coupon?.coupon?.startDate);
  const [endDate, setEndDate] = useState(coupon?.coupon?.endDate);
    ...
    <>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-xl font-extrabold text-gray-900">
          Update <span className="text-blue-600">{code}</span> Coupon
        </h2>
      </div>
